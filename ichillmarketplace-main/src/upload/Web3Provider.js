...
export default function Web3Provider ({ children }) {
  ...
  async function setupContracts (signer, networkName) {
    ...
    // console.log("marketplaceAddress:===",data.marketplaceAddress)
    const marketplaceContract = new ethers.Contract("0xA71b0b6DB0dbbc9Af6eDF0B15F34eAbAdb13311d", Market.abi, signer)
    setMarketplaceContract(marketplaceContract)
    const nftContract = new ethers.Contract("0xD0D740483D6279Da85bA84b8a184203427C1e224", NFT.abi, signer)
    setNFTContract(nftContract)
    const erc20Contract = new ethers.Contract("0x36B2D0da774869D30E7b1432aF6CC8a9050AeC97", ERC20.abi, signer)
