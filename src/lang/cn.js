export default {
    ...
    my_profile: {
        ...
        create_api_tips01: '此令牌是您访问Ichill -  Multichain Storage平台服务的私人机密。',
    ...
    uploadFile: {
        ...
        cid: 'CID',
        status: 'PIN状态',
        status_tooltip: '文件或数据在 Ichill -  Multichain Storage IPFS节点上的存储状态。',
        ...
        View_Your_NFT_OpenSea: '点击到Ichill NFT MaketPlace查看您的NFT',
        View_Your_NFT_Note: '注意：Ichill NFT MaketPlace需要一些时间加载您的NFT。',
        goTo: '前往',
        goTopage: '页',
