export default {
    ...
    navbar: {
        ...
        Tools: 'TOOLS',
        Stats: 'STATISTICS',
        copy: '© 2021 Ichill -  Multichain Storage',
    ...
    my_profile: {
        ...
        create_api_tips01: 'This token is your private secret to access Ichill -  Multichain Storage platform services.',
    ...
    uploadFile: {
        ...
        cid: 'CID',
        status: 'Pin Status',
        status_tooltip: "Reports the status of a file or piece of data stored on Ichill -  Multichain Storage's IPFS nodes.",
        ...
        View_Your_NFT_OpenSea: 'Click here to view your NFT on Ichill NFT MaketPlace',
        View_Your_NFT_Note: 'Note: The NFT will take some time to load on Ichill NFT MaketPlace.',
        goTo: 'Go to',
        goTopage: '',
